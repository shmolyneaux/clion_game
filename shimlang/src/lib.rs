...
pub fn format_asm(bytes: &[u8]) -> String {
    ...
    while idx < bytes.len() {
        ...
        if *b == ByteCode::Jmp as u8 {
            ...
            out.push_str(&format!("SHIM_VALUE"));
